import ComponentsMenu from "../../../Components/Menus/ComponentsMenu/Components.menu";
import {
  Flex,
  FlexDir,
  FlexTypes,
  ...
  return (
    <div className="flex justify-center">
      ...
      >
        ...
        <Flex direction={FlexDir.Col} align={FlexTypes.Start} className="gap-9 w-5/6">
          ...
          <List
            ...
            items={[
              <Flex className="text-left gap-2">
                <strong>Common: </strong> Basic components like buttons, icons, cards, and
                alerts that form the foundation of any user interface.
              </Flex>,
              <Flex className="text-left gap-2">
