  ...
  return (
    ...
    >
      ...
      <div className="w-1/2">
        ...
        <List
          ...
          items={[
            ...
            >
              ...
              Each component in Rainbow Plus UI is built with Tailwind's utility-first CSS
              framework, allowing you to easily override styles by passing in your own
              Tailwind classes. This approach lets you modify specific design
              elements—such as colors, margins, typography, and more—on the fly, ensuring
              that your UI remains flexible and dynamic without writing custom CSS.{" "}
            </p>,
            <p
              className=""
              style={{
            ...
            >
              ...
              needing to pass individual style classes each time. Variants provide an easy
              and consistent way to apply predefined styles (e.g., button sizes, color
              modes) across your application, making it simple to maintain uniformity
              while enabling quick adjustments for different use cases.{" "}
            </p>,
            <p
              className=""
              style={{
            ...
            >
              ...
              project demands a more tailored look and feel, Rainbow Plus UI allows you to
              override the default themes of its components. With our theming system, you
        ...
        />
        <Flex className="gap-4 my-5" justify={FlexTypes.SpaceEvenly}>
          <Button variant="lime">Variants</Button>
          <Button variant="success">Themes</Button>
      ...
      <div className="pb-9">
        <Button size={Sizes.Lg}>Explore Components</Button>
      </div>
    </Flex>
  );
};
