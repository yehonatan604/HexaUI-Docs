import { Button, Flex, List, RainbowBorder, ScrollArea } from "react-hexa-dev";
      ...
      >
        ...
        <div className="w-1/2">
          ...
          <p className="mt-4 text-lg ">
            ...
            offering an unparalleled level of customization. Whether you're aiming for
            quick design adjustments or a fully personalized interface, the flexibility of
            our library ensures that you can adapt it to meet your specific needs.
          </p>
            ...
            options={{
              ...
              items: [
                ...
                >
                  ...
                  ensuring that your UI remains flexible and dynamic without writing
                  custom CSS.{" "}
                </p>,
                <p
                  className=""
                ...
                >
                  ...
                  cohesive and branded UIs while maintaining control over the global
                  design system.{" "}
                </p>,
                <p
                  className=""
                ...
                >
                  <span className="font-bold">Built-in Variant Support: </span> Rainbow
                  Plus UI introduces Variants—pre-configured, reusable style options
                  within components that allow you to select different visual
                  presentations without needing to pass individual style classes each
                  time. Variants provide an easy and consistent way to apply predefined
                  styles (e.g., button sizes, color modes) across your application, making
                  it simple to maintain uniformity while enabling quick adjustments for
                  different use cases.{" "}
                </p>,
                <p
                  className=""
                ...
                >
                  ...
                  project demands a more tailored look and feel, Rainbow Plus UI allows
                  you to override the default themes of its components. With our theming
                  system, you can define custom themes that apply globally across your
                  app, giving you full control over component behavior and appearance.
                  This method ensures that your UI adheres to your brand's identity while
                  still utilizing the efficiency of pre-built, maintainable components.
                </p>,
              ],
            }}
          />
